...
namespace TestAppWPF
{
	...
	public partial class MainWindow : Window
	{
		...
		string targetCache;
		string windowTitleBase = "Easy Action for ArmA 3";
		...
		public MainWindow()
		{
			...
			browser.RootFolder = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
			...
			if (Properties.Settings.Default.profileDir == "" && Directory.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\ArmA 3"))
			{

				if (Directory.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\ArmA 3"))
				{
					MessageBox.Show("The default ArmA 3 profile was chosen. You can change your ArmA 3 profile in the settings.");
				...
				{
					MessageBox.Show("It appears that you do not have ArmA 3 installed." + "\n" + "No profile has been set.");
		...
		private void ResetElements(bool colouring, bool texts = false, bool label = false, bool buttonVisible = false)
		{
			if (colouring)
			{
				targetText.Background = Brushes.Transparent;
